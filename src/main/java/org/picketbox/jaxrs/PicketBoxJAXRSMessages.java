...
public interface PicketBoxJAXRSMessages {
    ...
    PicketBoxJAXRSMessages MESSAGES = Messages.getBundle(PicketBoxJAXRSMessages.class);
    ...
    ServletException servletException(@Cause Throwable throwable);
    ...
    IllegalStateException publicKeyRetrievalException(@Cause Throwable t);
}